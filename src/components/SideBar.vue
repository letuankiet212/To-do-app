        ...
        <div class="todo-app-menu">
          ...
          <div class="sidebar-menu-list">
            <div class="list-group list-group-filters font-medium-1">
              <a href="#" class="list-group-item list-group-item-action border-0 pt-0 " :class=" this.classActive == 'All' ? 'active' : '' " @click="filterName('All')">
            ...
            <div class="list-group list-group-filters font-medium-1">
              <a href="#" class="list-group-item list-group-item-action border-0" :class=" this.classActive == 'starred' ? 'active' : '' " @click="filterName('starred')"><i
                  class="font-medium-5 feather icon-star mr-50"></i> Starred</a>
              <a href="#" class="list-group-item list-group-item-action border-0" :class=" this.classActive == 'important' ? 'active' : '' " @click="filterName('important')"><i
                  class="font-medium-5 feather icon-info mr-50"></i> Important</a>
              <a href="#" class="list-group-item list-group-item-action border-0" :class=" this.classActive == 'Completed' ? 'active' : '' " @click="filterName('Completed')"><i
                  class="font-medium-5 feather icon-check mr-50"></i> Completed</a>
<!--              <a href="#" class="list-group-item list-group-item-action border-0" @click="filterName('starred')"><i-->
              ...
              <form id="form-add-todo" class="todo-input">
                ...
                <div class="modal-footer">
                  <fieldset class="form-group position-relative has-icon-left mb-0">
                    <button type="button" class="btn btn-primary add-todo-item" data-dismiss="modal"><i
